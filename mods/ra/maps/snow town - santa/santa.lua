...
WorldLoaded = function()
	...
	local santa = Actor.Create("santa", true, { Owner = neutral, Location = Spawn.Location, Facing = 64, CenterPosition = Spawn.CenterPosition + WVec.New(0, 0, Actor.CruiseAltitude("santa")) })
